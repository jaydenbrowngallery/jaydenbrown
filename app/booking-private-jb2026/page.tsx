          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="h-16 w-full rounded-[22px] border border-black/10 bg-[#f7f5f2] px-6 text-black/70 outline-none"
                >
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              ...
              <select
                ...
                className="h-16 rounded-[22px] border border-black/10 bg-[#f7f5f2] px-6 text-black/70 outline-none"
              >
