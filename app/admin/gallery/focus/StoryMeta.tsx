  ...
  return (
    <div>
      <p className="text-[13px] leading-[1.85] text-black/45">
        갤러리에 표시할 계절과 한 줄 멘트를 스토리별로 정합니다.
        <br />
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 flex gap-2">
                  <input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter") patch(it.id, { note: draft[it.id] ?? "" });
                    }}
                    maxLength={120}
                    placeholder="한 줄 멘트 (예: 벚꽃이 흩날리던 오후)"
                    className="min-w-0 flex-1 rounded-xl border border-black/10 bg-[#fafafa] px-3.5 py-2.5 text-[13px] text-black outline-none transition focus:border-black/25"
                  />
                  <button
