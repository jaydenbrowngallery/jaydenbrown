  ...
  return (
    <main className={`min-h-screen bg-[#f7f5f2] transition-all duration-1000 ease-out ${fadeIn ? "opacity-100 blur-0" : "opacity-0 blur-sm"}`}>
      <div className="mx-auto max-w-4xl px-6 py-20 md:px-10">
        ...
        {/* 타이틀 */}
        <p className="mb-4 text-[11px] uppercase tracking-[0.32em] text-black/30">About</p>

        <h1 className="text-[1.6rem] font-light leading-[1.45] tracking-[-0.02em] text-black/80 md:text-[2.4rem]">
          어느덧 20년에 가까운 시간을
          <br />
          카메라와 함께했습니다.
        </h1>
        ...
        {/* 본문 */}
        <div className="mt-12 space-y-6 text-[14px] leading-[2] text-black/50 md:text-[15.5px]">
          <p>
            시간이 흐르는 동안, 제가 돌잔치를 촬영했던 아이들이 다시 제 카메라 앞에 서는 순간들이 있습니다.
            그때마다, 어느새 저보다 훌쩍 자라 제가 올려다보게 된 그 모습을 마주하게 됩니다.
            그리고 그 순간, 처음 만났던 날이 겹쳐 보이듯 떠올라 조용히 웃게 됩니다.
          </p>
          ...
          <p>
            그 시간 동안 변하지 않은 것이 있다면, 더 좋은 사진을 위해 노력해왔다는 것입니다.
            늘 고민했고, 그 고민의 일부라 생각하며 장비에도 아낌없이 투자해왔습니다.
          </p>

          <p>
            이제는 아이들의 작은 손짓만 보아도 마음이 느껴지고,
            눈빛만으로도 그날의 감정을 읽을 수 있게 되었습니다.
          </p>

          <p>
            비단 아이들뿐만이 아닙니다.
            돌잔치, 칠순, 그리고 수많은 순간들 속에서 사람들의 표정과 분위기,
            그날의 공기까지도 자연스럽게 느껴집니다.
          </p>

          <p>
            그래서 알고 있습니다. 그날을 더 행복하게 만들기 위해 어떤 노력이 필요한지.
            그것은 연출이 아니라, 그 순간을 이해하고 흐름을 읽는 일입니다.
          </p>

          <div className="my-8 h-px w-16 bg-black/10" />

          <p className="text-black/60">
            20년 전에도, 지금도 변하지 않은 한 가지가 있습니다.
          </p>

          <p className="text-[15px] leading-[2] text-black/65 md:text-[16.5px]">
            사람들의 가장 소중한 순간에 제가 함께하고 있다는 사실이
            여전히 저를 설레게 합니다.
            <br />
            그리고 그 마음이 사진에 담긴다고 믿습니다.
          </p>
          ...
          <p className="text-[16px] font-medium leading-[1.8] text-black/75 md:text-[18px]">
            그냥, 믿고 맡겨주셔도 괜찮습니다.
          </p>

          <p>
            이 순간을 어떻게 남겨야 하는지에 대해 오랜 시간 고민해왔습니다.
            <br />
            그리고 그 마음으로 지금도 촬영하고 있습니다.
          </p>
        </div>
                    ...
                    >
                      ...
                      {admin && (
                        <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-black/0 transition group-hover:bg-black/30">
                          <span className="rounded-full bg-white/90 px-3 py-1.5 text-xs font-medium text-black opacity-0 transition group-hover:opacity-100">
                            변경
                          </span>
                        </div>
                      )}
