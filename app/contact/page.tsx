  ...
  return (
    <main className="min-h-screen bg-[#f7f5f2] px-6 py-20 md:px-10">
      <div className="mx-auto max-w-2xl">
        ...
        <a href="sms:01076651369" className="flex items-center gap-4 rounded-2xl bg-black px-6 py-5 transition hover:bg-black/80">
        ...
        <div className="mt-6 rounded-2xl bg-white border border-black/10 px-6 py-6">
          ...
          <ul className="space-y-3 text-sm text-black/55 leading-7">
            <li className="flex gap-3"><span className="text-black/20">01</span><span>희망 촬영 날짜</span></li>
            <li className="flex gap-3"><span className="text-black/20">02</span><span>부수 — 1부(식사 12시) · 2부(식사 14:30) · 3부(식사 18시)</span></li>
            <li className="flex gap-3"><span className="text-black/20">03</span><span>촬영 종류 — 돌스냅 · 고희연 · 웨딩</span></li>
          </ul>
        </div>
